...
export const MovieRow = memo(({ title, movies: initialMovies = [], isTop10 = false, genreId, type = 'movie' }: MovieRowProps) => {
  ...
  }, [page, hasMore, type, genreId, title]);
  ...
  return (
    <div className="relative group py-4 md:py-8">
      ...
      >
        {movies.map((movie, i) => (
          <div
            ...
            className={`${isTop10
              ...
              : 'min-w-[28.5%] md:min-w-[20%] lg:min-w-[16.66%] xl:min-w-[12.5%]'} relative snap-start flex-shrink-0`}
          >
            {isTop10 && (
              <div className="absolute -left-4 bottom-0 z-40 pointer-events-none select-none">
                <span className="text-[80px] md:text-[120px] lg:text-[180px] font-black leading-none text-transparent stroke-white drop-shadow-[0_0_20px_rgba(255,255,255,0.3)]"
        ...
        <div ref={observerRef} className="min-w-[15px] md:min-w-[30px] flex items-center justify-center pr-4 flex-shrink-0">
